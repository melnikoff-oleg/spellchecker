...
class SpellCheckModelNeuSpell(SpellCheckModelE2E):
    ...
    def correct_string(self, s) -> str:
        ...
        with open(path_prefix + 'grazie/spell/main/data/datasets/test.bea60k.noise.norm') as x:
            p = x.readlines()
        with open(path_prefix + 'grazie/spell/main/data/experiments/neuspell_bert_2/result_1.txt') as y:
            q = y.readlines()
